...
//Styles
/*
if (settings.gen.dark) {
    document.body.style.background = "linear-gradient(90deg, rgba(76,175,167,1) 0%, rgba(6,0,108,1) 100%)";
    const allTaskContainers = document.querySelectorAll(".task-container");
    allTaskContainers.forEach((element) => {
        element.style.background = "rgb(300,30,40)";
    });
    ...
    document.body.style.background = "rgb(240, 250, 250)";

    const allTaskContainers = document.querySelectorAll(".task-container");
    allTaskContainers.forEach((element) => {
        element.style.background = "rgb(240, 248, 255)";
    });
